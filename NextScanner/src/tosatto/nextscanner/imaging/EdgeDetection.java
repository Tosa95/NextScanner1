...
public class EdgeDetection {
    ...
    public static int[] horizontalCuts = {30, 90, 150, 210};
    public static int[] verticalCuts = {40, 120, 200, 280};



    public static void printEdgesTest(BufferedImage image, boolean reversex, boolean reversey, int rangex, int rangey){
    ...
    public static int getEdge(int[] edges, int range){
    ...
    public static int[] getEdges(BufferedImage image, int[] arr, boolean reverse, boolean verticalEdge){
        int red = 255;
        int green = 255;
        int blue = 255;
